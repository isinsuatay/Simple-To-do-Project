...
export const canisterId = process.env.CANISTER_ID_SIMPLE_TO_DO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./simple_to_do.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the simple_to_do canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./simple_to_do.did.js")._SERVICE>}
 */
export const simple_to_do = createActor(canisterId);
